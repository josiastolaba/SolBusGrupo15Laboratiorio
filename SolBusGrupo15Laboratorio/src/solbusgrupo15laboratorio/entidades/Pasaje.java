...
public class Pasaje {
    ...
    public String toString() {
        return "Pasaje=" + idPasaje +" /Pasajero "+ idPasajero.getIdPasajero() +" /Colectivo "+  idColectivo.getIdColectivo() +" /Ruta "+ idRuta.getIdRuta() +" /Fecha "+ fechaViaje +" /Hora "+ horaViaje +" /Asiento "+ asiento +" /Precio "+ precio;
    }
